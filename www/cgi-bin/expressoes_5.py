...
for expression in dictExpressions:
    ...
    html += f"<tr><td style='padding:10px;'><a target='_blank' style='text-decoration:none; color:blue;' href='../cgi-bin/interrogar.py?params={encodeUrl(expression['expression'])}'>" + expression['expression'] + "</a></td><td style='padding:10px;'>" + sentence.text + "</td></tr>"
